    ...
    <div className="bg-gray-100">
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-wrap -mx-4">
          ...
          <Image className="w-full h-auto rounded-lg shadow-md mb-4"
            loader={imageLoader} src={image} width={320} height={320} alt='product image'/>
            <div className="flex gap-4 py-4 justify-center overflow-x-auto">
              {product?.images.map((img, i) => {
                return (
                  <Image key={i} className="size-16 sm:size-20 object-cover rounded-md cursor-pointer opacity-60 hover:opacity-100 transition duration-300"
                    loader={imageLoader} src={img} width={320} height={320} alt='product image'
