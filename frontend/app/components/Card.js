...
function Card({product}) {
  ...
  return (
    <div className="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
      <Link className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href={`/products/${product._id}`}>
      <Image loader={imageLoader} src={product?.images[0]} width={320} height={320} alt='recipe image'/>
      ...
      <div className="mt-4 px-5 pb-5">
        ...
        <div className="mt-2 mb-5 flex items-center justify-between">
          <p>
            ...
            <span className="text-sm text-slate-900 line-through">{product?.discount}</span>
          </p>
